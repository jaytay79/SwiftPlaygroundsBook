...
class GoalCounter: UIImageView {
    ...
    lazy var maxiumuLabelWidth: CGFloat = self.labelWidth(for: "99/99")
    ...
    func commonInit() {
        self.image = Asset.image(named: "Board")
        
        // Set images
        let gemImageView = UIImageView(image: Asset.image(named: "GemCount"))
        let switchImageView = UIImageView(image: Asset.image(named: "SwitchCount"))
        let centerImageView = UIImageView(image: Asset.image(named: "BoardRope"))
    ...
    func updateLabels() {
        ...
        let gemWidth = widthForLabel(gemLabel)
        let switchWidth = widthForLabel(switchLabel)
        ...
        UIView.animate(withDuration: 0.5) {
            ...
            self.gemLabel.widthConstraint?.constant = gemWidth
            self.switchLabel.widthConstraint?.constant = switchWidth
        }
    }
