...
//
let success = "### Wonderful work! \nYou've completed Learn to Code 2. Go ahead and celebrate; that’s quite an accomplishment! But it’s not the end of your journey-it’s only the beginning. Learning to code is like learning to speak a language-you need to practice to get better. Try using your new skills in some of the earlier puzzles, and see if you can solve them by using more advanced solutions. Or better yet, try some coding challenges. However you choose to practice, get out there and keep coding!"
let hints = [
